...
public class DateUtil {
    public static long hours2millis(double hours) { return (long)(3600000*hours); }
    public static long mins2millis(double minutes) { return (long)(60000*minutes); }
    public static long seconds2millis(double seconds) { return (long)(1000*seconds); }
    public static int millis2hours(long millisecondsElapsed) { return (int) Math.floor(millisecondsElapsed/(60.0*60.0*1000.0)); }
    public static int millis2mins(long millisecondsElapsed) { return (int) Math.floor(millisecondsElapsed/(60.0*1000.0)); }
    public static int millis2seconds(long millisecondsElapsed) { return (int) Math.floor(millisecondsElapsed/1000.0); }
